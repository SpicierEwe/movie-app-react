...
import { fetchFavorites, updateFovourites } from "../state/slices/moviesSlice";
  ...
  if (favouritesMoviesList.length === 0) {
    return (
      <div className="flex justify-center items-center gap-3 mt-12 flex-col">
        ...
        <p>
          You can add a movie to favourite by click on the heart icon. Find
          Movies here <Link src="/home">Home</Link>
        </p>
      </div>
    );
  }
            ...
            >
              <div className="relative  w-full rounded-xl ">
                ...
                <div class="absolute top-5 right-5 flex items-center flex-col gap-y-5">
                  ...
                  >
                    <IoMdRemoveCircle size={25} className="text-red-600" />
                  </div>
                </div>
