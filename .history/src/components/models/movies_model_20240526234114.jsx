...
export default function MovieModel({ movie, isFavourite }) {
  const imageLink =
  ...
  return (
    <div
      key={movie.index}
      className="group w-auto border-2 border-gray-900 bg-[#202124] bg-red-500 rounded-xl overflow-hidden hover:-translate-y-1 transform transition duration-500 ease-in-out"
    >
      <Link
        to={movie.imdb_url}
        target="_blank"
      ...
      >
        <img src={imageLink} alt="movie" className="object-cover" />
      </Link>
