          ...
          {movies.map((movie, index) => (
            <div key={index} className="group">
              ...
              >
                ...
                <div class="absolut  top-5 right-5">
                  <FaStar
                    size={50}
                    class="absolute bg-white text-yellow-500 rounded-full p-1"
                  ></FaStar>
                  <h1 className="text-xl font-bold absolute top-5 right-5 z-20 flex justify-center align-center">
                    {movie.rating}
                  </h1>
                </div>
