          ...
          {movies.map((movie, index) => (
            <div key={index} className="group">
              ...
              >
                ...
                <div class="absolute top-5 right-5 flex justify-center align-center">
                  <FaStar
                    size={50}
                    class="relative text-white rounded-full p-1"
                  />
                  <h1 className="absolute top-50 left-50 text-xl font-bold  z-20">
                    {movie.rating}
                  </h1>
                </div>
