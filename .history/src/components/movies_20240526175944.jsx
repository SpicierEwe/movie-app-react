...
export default function MoviesComponent() {
  ...
  return (
    <div>
      {!isLoading && (
        <div
          className="ml-auto  mr-auto mt-12 mb-12 pt-16 grid grid-cols-4 gap-12 max-w-screen-xl overflow-hidden hover:-translate-y-1
        transform transition duration-500 ease-in-out "
        >
          {movies.map((movie, index) => (
            <div key={index} class="group border-2 border-gray-50 rounded-xl ">
              <div className="relative  w-full rounded-xl ">
                ...
                <p className=" text-md text-white text-gray-900 p-5 pl-0">
                  {movie.movie}
                </p>
              </div>
            </div>
